...
with_options presence: true do
  ...
  validates :title
  validates :price, numericality: { only_integer: true, message: "must be half-width number" }, numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9_999_999 }
